...
class Triangle: public Primitive {
    private:
        ...
        double area;
    public:
        Triangle(const Vector3 v0, const Vector3 v1, const Vector3 v2, const Material material, const bool normals=false, const Vector3 vn0 = Vector3(0.), const Vector3 vn1 = Vector3(0.), const Vector3 vn2 = Vector3(0.));
